    ...
    <div class="mx-auto max-w-7xl px-5 py-8 sm:px-8">
        <div class="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            <div>
                ...
                <div class="mt-1 font-mono text-[11px] uppercase tracking-[.16em] text-stone-700">
                    software feito com código limpo e café forte.
                </div>
            </div>

            <div class="flex flex-wrap gap-6 font-mono text-[11px] uppercase tracking-[.15em] text-stone-600">
            ...
            <div class="font-mono text-[11px] text-stone-700">© {{ now()->year }} coffee.dev</div>
        </div>
    </div>
</footer>
