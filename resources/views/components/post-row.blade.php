...
<a class="article block border-t border-stone-800 py-7" href="{{ route('blog.show', $post['slug']) }}">
    <div class="grid gap-5 md:grid-cols-[110px_1fr_90px] md:items-start">
        <time datetime="{{ $post['data_iso'] }}" class="font-mono text-[12px] text-stone-600">
        ...
        <div class="font-mono text-[11px] text-stone-700 md:text-right">{{ sprintf('%02d', $minutes) }} MIN</div>
    </div>
</a>
